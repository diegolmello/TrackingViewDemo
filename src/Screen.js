    ...
    return (
      <View flex bg-dark80 paddingT-page>
        ...
        >
          ...
          <View row marginV-20 centerV spread>
            <Button label='Open new tracking view' onPress={this.pushScreen} />
          </View>
        ...
        <KeyboardTrackingView
          ...
          addBottomView
          iOSScrollBehaviour={NativeModules.KeyboardTrackingViewTempManager?.KeyboardTrackingScrollBehaviorFixedOffset}
        >
